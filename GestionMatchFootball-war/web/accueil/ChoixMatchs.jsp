...
<section class="section" style="margin-top:2rem">
    ...
    %>         
    <h1 class="title">Liste des matchs</h1>
    <form method="post" action="${pageContext.request.contextPath}/AccesCommun">
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <p class="subtitle" style="margin-top: 1rem"><%=dateFormat.format(m.getDate())%></p>
                                ...
                                <label for="radio<%=i%>">Choisir ce match</label>
                            </p>
                        </div>
                </div>
            </div>
        ...
        <input value="getEffectifMatch" name="action" type="hidden">
        <input style="margin-top: 1rem" class="button is-large is-success" value="Afficher l'effectif du match" type="submit">
    </form>
</section>
