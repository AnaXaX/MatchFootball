...
<section class="section" style="margin-top:2rem">
    ...
    <form method="post" action="${pageContext.request.contextPath}/AccesEntraineur">
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <p class="subtitle" style="margin-top: 1rem"><%=dateFormat.format(m.getDate())%></p>
                                ...
                                <label for="radio<%=i%>">Modifier ce match</label>
                            </p>
                        </div>
                </div>
            </div>
        ...
        <input value="setEffectifMatch" name="action" type="hidden">
        <input style="margin-top: 1rem" class="button is-large is-success" value="Changer l'effectif du match" type="submit">
    </form>
</section>
