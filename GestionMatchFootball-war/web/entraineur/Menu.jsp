...
<section class="section animated fadeIn">
    ...
    <% if(eq!=null){ %>
    <a href="${pageContext.request.contextPath}/AccesArbitre?action=affecterJoueur" >
        <div class="box">
            <article class="media">
    ...
    <a href="${pageContext.request.contextPath}/AccesArbitre?action=transfererJoueur">
        <div class="box">
            <article class="media">
                <div class="media-left">
                    <figure class="image is-64x64">
    ...
    <a href="${pageContext.request.contextPath}/AccesArbitre?action=supprimerJoueur">
        <div class="box">
            <article class="media">
                <div class="media-left">
                    <figure class="image is-64x64">
    ...
    <a href="${pageContext.request.contextPath}/AccesArbitre?action=affecterJoueurEffectif">
        <div class="box">
            <article class="media">
                <div class="media-left">
                    <figure class="image is-64x64">
    ...
    <% } %>
    <form method="poqt" action="${pageContext.request.contextPath}/AccesEntraineur">                     
