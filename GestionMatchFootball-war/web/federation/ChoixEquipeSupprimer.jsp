...
<section class="section" style="margin-top:2rem">
    ...
    <form method="post" action="${pageContext.request.contextPath}/AccesFederation">
                    ...
                    <div class="card">
                        <div class="card-content">                         
                            ...
                            <p class="subtitle" style="margin-top: 1rem">                               
                                <input class="is-checkbox" id="checkbox<%=i%>" type="checkbox" name="idEquipes" value="<%=e.getId()%>">
                                <label for="checkbox<%=i%>">Supprimer cette Equipe</label>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <input value="supprimerEquipes" name="action" type="hidden">
        <input style="margin-top: 1rem" class="button is-large is-danger" value="Supprimer ces équipes" type="submit">
    </form>
