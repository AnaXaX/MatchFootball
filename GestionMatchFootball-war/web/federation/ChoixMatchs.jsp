...
<section class="section" style="margin-top:2rem">
    ...
    <form method="post" action="${pageContext.request.contextPath}/AccesFederation">
        ...
        <input value="modifierMatch" name="action" type="hidden">
        <input style="margin-top: 1rem" class="button is-large is-success" value="Modifier la date du match" type="submit">
    </form>
</section>
